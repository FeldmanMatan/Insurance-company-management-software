...
public class NewApartmentController implements Initializable {
    ...
    void SaveHandler(ActionEvent event) {
    	...
    	DataBase.addNeInsurance(new Insurance(name,LastName,Date,Remark,"Apartment"));
    	lg.logger.info("new Apartment Insurance added name: "+name+" Last name: "+LastName+" Date: "+Date+" Remark: "+Remark);
    	nameTB.clear();
    	FamilyNameTB.clear();
    	DateTB.clear();
    	RemarkTB.clear();
