...
public class NewCarController implements Initializable{
    ...
    void SaveHandler(ActionEvent event) {
    	...
    	DataBase.addNeInsurance(new Insurance(name,LastName,Date,Remark,"Car"));
    	lg.logger.info("new car Insurance added name: "+name+" Last name: "+LastName+" Date: "+Date+" Remark: "+Remark);
    	nameTB.clear();
    	FamilyNameTB.clear();
    	DateTB.clear();
    	RemarkTB.clear();
