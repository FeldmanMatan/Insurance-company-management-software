...
public class NewHealthController implements Initializable {
    ...
    void SaveHandler(ActionEvent event) {
    	...
    	DataBase.addNeInsurance(new Insurance(name,LastName,Date,Remark,"Health"));
    	lg.logger.info("new health Insurance added name: "+name+" Last name: "+LastName+" Date: "+Date+" Remark: "+Remark);
    	nameTB.clear();
    	FamilyNameTB.clear();
    	DateTB.clear();
    	RemarkTB.clear();
